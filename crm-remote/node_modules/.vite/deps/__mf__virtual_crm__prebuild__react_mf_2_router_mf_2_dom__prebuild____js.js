import {
  require_crm_loadShare_react_mf_2_dom_loadShare
} from "./chunk-HN7UCZZ4.js";
import {
  require_crm_loadShare_react_loadShare
} from "./chunk-7DOJ4Q3Y.js";
import "./chunk-EZ7PMXFW.js";
import {
  __commonJS,
  __esm,
  __toESM
...
var init_chunk_WWGJGFF6 = __esm({
  "node_modules/react-router/dist/development/chunk-WWGJGFF6.mjs"() {
    React = __toESM(require_crm_loadShare_react_loadShare(), 1);
    React2 = __toESM(require_crm_loadShare_react_loadShare(), 1);
    React3 = __toESM(require_crm_loadShare_react_loadShare(), 1);
    React4 = __toESM(require_crm_loadShare_react_loadShare(), 1);
    React9 = __toESM(require_crm_loadShare_react_loadShare(), 1);
    React8 = __toESM(require_crm_loadShare_react_loadShare(), 1);
    React7 = __toESM(require_crm_loadShare_react_loadShare(), 1);
    React6 = __toESM(require_crm_loadShare_react_loadShare(), 1);
    React5 = __toESM(require_crm_loadShare_react_loadShare(), 1);
    React10 = __toESM(require_crm_loadShare_react_loadShare(), 1);
    React11 = __toESM(require_crm_loadShare_react_loadShare(), 1);
    __typeError = (msg) => {
      throw TypeError(msg);
    };
...
var init_chunk_PMGK554W = __esm({
  "node_modules/react-router/dist/development/chunk-PMGK554W.mjs"() {
    init_chunk_WWGJGFF6();
    React12 = __toESM(require_crm_loadShare_react_loadShare(), 1);
    React22 = __toESM(require_crm_loadShare_react_loadShare(), 1);
    import_cookie = __toESM(require_dist(), 1);
    import_set_cookie_parser = __toESM(require_set_cookie(), 1);
    React42 = __toESM(require_crm_loadShare_react_loadShare(), 1);
    import_react = __toESM(require_crm_loadShare_react_loadShare(), 1);
...
var init_dom_export = __esm({
  "node_modules/react-router/dist/development/dom-export.mjs"() {
    ...
    init_chunk_PMGK554W();
    init_chunk_WWGJGFF6();
    React13 = __toESM(require_crm_loadShare_react_loadShare(), 1);
    ReactDOM = __toESM(require_crm_loadShare_react_mf_2_dom_loadShare(), 1);
    React23 = __toESM(require_crm_loadShare_react_loadShare(), 1);
    React33 = __toESM(require_crm_loadShare_react_loadShare(), 1);
    ReactDOM2 = __toESM(require_crm_loadShare_react_mf_2_dom_loadShare(), 1);
    ssrInfo = null;
    router = null;
...
//# sourceMappingURL=__mf__virtual_crm__prebuild__react_mf_2_router_mf_2_dom__prebuild____js.js.map
